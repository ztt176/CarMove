<!--
 * @Author: your name
 * @Date: 2021-06-25 10:56:14
 * @LastEditTime: 2021-09-18 13:57:06
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \MoveDapWebUi\src\views\myService\sailingRecord.vue
-->
<template>
<div>
        ...
        <el-col :span="12" v-for="(item,index) in recordsList" :key="index" style="margin-bottom:10px">
            <el-row :gutter="10" style="padding:10px;background:rgba(255, 255, 255, 0.1);color:white;border-radius:5px;">
                <el-col :span="18">
                    ...
                    <div style="font-size:12px;text-align:left">{{item.distance/1000}} km</div>
                </el-col>
...
export default {
    ...
    methods: {
        getList(id) {
            ...
            recordsCustomer(this.form).then(res => {
            ...
            this.$nextTick(() => {
                ...
                getPath(id).then((res) => {
                    ...
                    if (data.length > 0) {
                        ...
                        this.pathData = [];
                        this.$message({type:'waring',message:'当前走航记录没有路径'})
                    }
                })
            })
        },
